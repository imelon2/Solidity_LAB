...
import Order from "../../artifacts/contracts/work/Order.sol/Order.json"
import DKA from "../../artifacts/contracts/work/DKA.sol/DKA.json"
...
export class dataGenerator {
    ...
    constructor(provider: any) {
        this.tokenContract = new ethers.Contract(CA.DKA, DKA.abi, provider);
        this.orderContract = new ethers.Contract(CA.OrderCA, Order.abi, provider);
        this.forwarderContract = new ethers.Contract(CA.TxForwarderCA, TxForwarder.abi, provider);
    }
